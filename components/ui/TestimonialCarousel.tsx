...
const testimonialsData: Testimonial[] = [
  {
    id: 1,
    name: "Jane Doe",
    avatar: "/assets/images/Développement web.jpg",
    description: "This company changed my life!",
  },
  {
    id: 2,
    name: "John Smith",
...
>(
  (
    { className, testimonials = testimonialsData, showArrows = true, showDots = true, ...props },
    ref
  ) => {
...
export { TestimonialCarousel, testimonialsData, type Testimonial }

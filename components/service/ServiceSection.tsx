...
const ServiceServices = () => {
  const services = [
    {
      ...
      description: "Modernisez vos processus et opérations avec les dernières technologies numériques.",
      icon: Code,
      bgColor: "bg-gray-100",
   ...
   
    {
      ...
      description: "Boostez la visibilité de vos produits ou services et générez des ventes.",
      icon: QrCode,
      bgColor: "bg-gray-100",
      textColor: "text-gray-800",
      iconBg: "bg-purple-100",
    ...
    },
     {
      id: "04",
      title: "Communication",
      description: "Gérez votre communication interne et externe pour maintenir une image positive.",
      icon: Megaphone,
      bgColor: "bg-gray-100",
      textColor: "text-gray-800",
      iconBg: "bg-purple-100",
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
     <div className='border-2 border-red-700 py-28' >
       <h1 className='text-center text-[#A639FF] text-3xl  font-bold'>Nos Services</h1>
      <h2 className='text-xl sm:px-52' >  Boostez votre entreprise avec nos services digitaux personnalisés, conçus pour répondre à 
        vos besoins spécifiques et accélérer votre succès dans le monde numérique.</h2>
     </div>
